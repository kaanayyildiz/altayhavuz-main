...
@section('title', 'Yeni Portfolyo Kategorisi - Admin')

@section('content')
    <h1 class="text-2xl font-bold mb-4">Yeni Kategori</h1>

    <form action="{{ route('admin.portfolio-categories.store') }}" method="POST" class="bg-white border rounded-xl p-6 space-y-5 max-w-2xl">
        @csrf
